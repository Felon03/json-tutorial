...
static void test_parse_array()
{
    ...
    // // parse sub element [0]
    // lept_value* a = lept_get_array_element(&v, 1);   // a = [0]
    // EXPECT_EQ_INT(LEPT_ARRAY, lept_get_type(a));
    // EXPECT_EQ_SIZE_T(1, lept_get_array_size(a));
    // lept_value* e = lept_get_array_element(a, 0);
    // EXPECT_EQ_INT(LEPT_NUMBER, lept_get_type(e));
    // EXPECT_EQ_DOUBLE(0.0, lept_get_number(e));
    // // parse sub element [0, 1]
    // a = lept_get_array_element(&v, 2);               // a = [0, 1]
    // EXPECT_EQ_INT(LEPT_ARRAY, lept_get_type(a));
    // EXPECT_EQ_SIZE_T(2, lept_get_array_size(a));
    // for (int j = 0; j < 2; ++j) {
    //     e = lept_get_array_element(a, j);
    //     EXPECT_EQ_INT(LEPT_NUMBER, lept_get_type(e));
    //     EXPECT_EQ_DOUBLE((double)j, lept_get_number(e));
    // }
    // // parse sub element [0, 1, 2]
    // a = lept_get_array_element(&v, 3);               // a = [0, 1, 2]
    // EXPECT_EQ_INT(LEPT_ARRAY, lept_get_type(a));
    // EXPECT_EQ_SIZE_T(3, lept_get_array_size(a));
    // for (int j = 0; j < 3; ++j) {
    //     e = lept_get_array_element(a, j);
    //     EXPECT_EQ_INT(LEPT_NUMBER, lept_get_type(e));
    //     EXPECT_EQ_DOUBLE((double)j, lept_get_number(e));
