...
{
    TEST_ERROR(LEPT_PARSE_ROOT_NOT_SIGNULAR, "null x");

    // invalid number
    TEST_ERROR(LEPT_PARSE_ROOT_NOT_SIGNULAR, "0123");    // after zero should be '.' or nothing
    TEST_ERROR(LEPT_PARSE_ROOT_NOT_SIGNULAR, "0x0");
    TEST_ERROR(LEPT_PARSE_ROOT_NOT_SIGNULAR, "0x123");
}
